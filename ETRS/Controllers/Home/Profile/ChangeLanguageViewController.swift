...
class ChangeLanguageViewController: UIViewController {
    ...
    override init(nibName nibNameOrNil: String?, bundle nibBundleOrNil: NSBundle?) {
        ...
        self.contentSizeInPopup = CGSizeMake(300, 120)
    }
    ...
    func configButtons() {
        jaBT = MKButton(frame: CGRect(x: 0, y: 0, width: self.view.frame.width, height: 40))
        ...
        viBT = MKButton(frame: CGRect(x: 0, y: self.jaBT.frame.height, width: self.view.frame.width, height: 40))
        ...
        enBT = MKButton(frame: CGRect(x: 0, y: self.jaBT.frame.height + self.viBT.frame.height, width: self.view.frame.width, height: 40))
